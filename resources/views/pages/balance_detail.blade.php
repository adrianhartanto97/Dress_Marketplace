                                            ...
                                            <div class="col-md-12" style="text-align:center;">
                                                <form method="post" action="{{ action('Web_Controller\App2Controller@balance_withdraw') }}" class="form-horizontal" id="form1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" class="form-control form-control-solid placeholder-no-fix" name="name_in_bank_acount" placeholder="name_in_bank_acount" value="{{ old('name_in_bank_acount') }}" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
