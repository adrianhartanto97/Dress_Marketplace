...
class UpdateProductView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        a.style_id,
        c.style_name,
        a.season_id, d.season_name,
        a.neckline_id, e.neckline_name,
        a.sleevelength_id, f.sleevelength_name,
        a.waiseline_id, g.waiseline_name,
        a.material_id, h.material_name,
        a.fabrictype_id, i.fabrictype_name,
        a.decoration_id, j.decoration_name,
        a.patterntype_id, k.patterntype_name,
        a.product_type, a.product_active_status, a.product_ownership, a.created_at, a.updated_at,
        ...
        a.product_id = l.product_id left join view_sold_product m on a.product_id = m.product_id
        ");
    }
    ...
    public function down()
    {
        ...
        a.fabrictype_id = i.fabrictype_id inner join product_decoration_attribute j on
        a.decoration_id = j.decoration_id inner join product_patterntype_attribute k on
        a.patterntype_id = k.patterntype_id
        ");
    }
}
