...
class CreateCartDetailView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        select
            a.user_id, e.store_id, e.name as 'store_name',e.photo as 'store_photo', a.product_id, d.name as 'product_name', d.photo as 'product_photo', a.product_size_id, b.size_name, a.product_qty, a.created_at, a.updated_at
        from
