...
class CreateStorePendingView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("CREATE OR REPLACE VIEW view_store_pending AS 
        select
    ...
    {
        DB::statement("DROP VIEW view_store_pending");
    }
}
