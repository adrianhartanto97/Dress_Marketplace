...
Route::group(['middleware' => 'auth.custom'], function () {
    ...
    Route::post('seller_panel', 'Web_Controller\SellerController@seller_panel_dashboard');
    ...
    Route::post('read_notification', 'Web_Controller\AppController@read_notification');
});
